...
If the selected segments follow one another, **A** and **B** take you to the two ends of the chain (A on the node-A side of the first selected segment), and **◎** to its middle. If they do not, **Fit** and **Middle** (centre of the area) remain.
...
* Built on the WME SDK, no dependency. Its only request outside waze.com: at most once a day, it reads the version number published on GreasyFork, to show a red badge in the Scripts tab when an update is out.
