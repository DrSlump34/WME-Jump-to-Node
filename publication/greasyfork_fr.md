...
Si les segments sélectionnés se suivent, **A** et **B** mènent aux deux bouts de la chaîne (A du côté du nœud A du premier segment sélectionné), et **◎** à son milieu. Sinon, **Tout voir** et **Milieu** (centre de l’emprise) restent proposés.
...
* Construit sur le SDK de WME, sans dépendance. Sa seule requête hors de waze.com : au plus une fois par jour, il lit le numéro de version publié sur GreasyFork, pour allumer une pastille rouge dans l’onglet Scripts quand une mise à jour est sortie.
